...
class SpotifySdkService extends StatefulWidget {
  const SpotifySdkService({super.key});

  @override
  State<SpotifySdkService> createState() => _SpotifySdkServiceState();
}

class _SpotifySdkServiceState extends State<SpotifySdkService> {
  bool _loading = false;
