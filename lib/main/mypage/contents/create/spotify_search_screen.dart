...
class SpotifySearchScree extends StatefulWidget {
  const SpotifySearchScree({super.key});

  @override
  State<SpotifySearchScree> createState() => _SpotifySearchScreeState();
}

class _SpotifySearchScreeState extends State<SpotifySearchScree>
