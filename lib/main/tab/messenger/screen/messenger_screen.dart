              ...
              children: [
                ...
                Center(
                  child: Container(
                    ...
                    child:
                        messengerData.chatRooms[index].get('chatImage').isEmpty
                            ? const Icon(
                                Icons.add,
                                color: Colors.grey,
                                size: 40,
                ...
                Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      width: 120,
                      child: Text(
                        messengerData.chatRooms[index].get('member').isEmpty
                            ? '채팅 멤버'
                            : messengerData.chatRooms[index]
                                .get('member')
                                .join(','),
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  width10,
                  Text('${messengerData.chatRooms[index].get('member').length}',
                      style: const TextStyle(
                          color: Colors.white,
                          fontSize: 15,
                          fontWeight: FontWeight.bold)),
